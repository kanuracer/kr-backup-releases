...
- Version: `0.1.15`
- Update asset: `KR-Backup-v0.1.15-update-from-0.1.x.zip`
- Update SHA256: `9adf22663eaf72c61b50673c99c17e37e9e475478c33920addcc1774a76b3703`
- Full portable ZIP: `KR-Backup-v0.1.15-win-x64-portable.zip`
- Full portable SHA256: `0c67e42ea03a7bce4bd136a876bb72d793628117a6b2c22fd2293031d9b3bc51`
...
Download latest: [KR-Backup-v0.1.15-win-x64-portable.zip](https://raw.githubusercontent.com/kanuracer/kr-backup-releases/main/KR-Backup-v0.1.15-win-x64-portable.zip)

GitHub Release: [KR Backup v0.1.15](https://github.com/kanuracer/kr-backup-releases/releases/tag/v0.1.15)
...
- Die Progressbar zeigt wieder direkt Prozent, kopierte/Gesamtgröße und Geschwindigkeit, z. B. `54% · 277,0 MB/512,0 MB · 615,2 MB/s`.
- Das große Status-Panel im Backup-Tab bleibt standardmäßig ausgeblendet.
- `Einstellungen → Backup → Livestatus einblenden` zeigt/versteckt nur das große Status-Panel.
- Die Detailzeile unter der Progressbar bleibt sichtbar.
...
2. Die Datei `KR-Backup-v0.1.15-win-x64-portable.zip` speichern.
3. Warten, bis der Download abgeschlossen ist.

Direktlink:

```text
https://raw.githubusercontent.com/kanuracer/kr-backup-releases/main/KR-Backup-v0.1.15-win-x64-portable.zip
```

## 3. ZIP entpacken

1. Im Download-Ordner die Datei `KR-Backup-v0.1.15-win-x64-portable.zip` suchen.
...
```powershell
Get-FileHash .\KR-Backup-v0.1.15-win-x64-portable.zip -Algorithm SHA256
```

Erwarteter SHA256:

```text
0c67e42ea03a7bce4bd136a876bb72d793628117a6b2c22fd2293031d9b3bc51
```
